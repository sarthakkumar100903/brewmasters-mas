export interface GameState {
  ...
  green_team_last_production_target: number;
  green_team_last_marketing_spend: number;
  green_team_total_production: number;
  green_team_total_sales: number;
  ...
  blue_team_last_production_target: number;
  blue_team_last_marketing_spend: number;
  blue_team_total_production: number;
  blue_team_total_sales: number;
  event_log: string[];
  turn_history: {
    turn: number;
    green_team_price: number;
    ...
    green_team_profit_this_turn: number;
    green_team_total_profit: number; // New: Total profit for chart
    blue_team_price: number;
    blue_team_marketing_spend: number;
    blue_team_production_target: number;
    blue_team_sales: number;
    blue_team_profit_this_turn: number;
    blue_team_total_profit: number; // New: Total profit for chart
  }[];
}